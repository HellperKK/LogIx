...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "LogIx", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "LogIx";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LogIx", null, { width: 640, height: 480 });
